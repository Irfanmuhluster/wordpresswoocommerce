...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'               => 'Intergeo Maps Plugin', // The plugin name.
            'slug'               => 'intergeo-maps-plugin', // The plugin slug (typically the folder name).
            'source'             => get_template_directory_uri() . '/inc/plugins/intergeo-maps.zip', // The plugin source.
